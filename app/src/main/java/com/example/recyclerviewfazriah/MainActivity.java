package com.example.recyclerviewfazriah;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareMahasiswaData() {
        ...
        mahasiswaList.add(new Mahasiswa("Siti Fazriah","311710433","089665960321"));
        mahasiswaList.add(new Mahasiswa("Afif Fathurohman","311710477","081387102299"));
        mahasiswaList.add(new Mahasiswa("Dimas Panji Adityantoro","311710065","087782739920"));
        mahasiswaList.add(new Mahasiswa("Widi Anggraeni Puspitasari","311710603","081233898365"));
